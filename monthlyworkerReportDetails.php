...
WHERE 
washer = '$workerName' 
AND recdate BETWEEN DATE_SUB(NOW(), INTERVAL $workerDays MONTH) AND NOW() order by recdate asc
...
$pdf->Cell(0, 10, 'Worker Monthly Report Details', 0, 1, 'C');
...
// Output the PDF
$pdf->Output('F','report/workerMonthlyReport.pdf');
