...
// prepare the insert statement with placeholders for the variables
...
$pdf->Line(5, 50, 70, 50); // Draw the line from (10, 50) to (200, 50)

// Add the services and amounts
$pdf->SetFont('Arial', 'B', 12);
